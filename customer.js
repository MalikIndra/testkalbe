...
<tbody>
    <tr v-for="cus in customers">
        ...
        <td>
            ...
            <button type="button" @click="deleteClick(cus.CustomerId)"
            class="btn btn-light mr-1">
...
data(){
    return{
        ...
        CustomerName:"",
        CustomerAddress:"",
        CustomerPhoto:"anonymous.png",
        PhotoPath:variables.PHOTO_URL
    }
},
methods:{
    refreshData(){
        axios.get(variables.API_URL+"customer")
        .then((response)=>{
    ...
    addClick(){
        ...
        this.CustomerPhoto="anonymous.png"
    },
    editClick(cus){
        ...
        this.CustomerPhoto=cus.CustomerPhoto
    },
    createClick(){
        axios.post(variables.API_URL+"customer",{
    ...
    updateClick(){
        axios.put(variables.API_URL+"customer",{
    ...
    deleteClick(id){
        ...
        axios.delete(variables.API_URL+"customer/"+id)
        .then((response)=>{
            this.refreshData();
            alert(response.data);
        });
    ...
    imageUpload(event){
        ...
        axios.post(
            variables.API_URL+"customer/savefile",
            formData)
            .then((response)=>{
                this.CustomerPhoto=response.data;
            });
    }
